    ...
    <div className="min-h-screen bg-black text-white flex items-center justify-center">
      <div className="text-center px-6 max-w-2xl mx-auto">
        ...
        <motion.h1
          ...
          className="text-4xl md:text-6xl lg:text-[5rem] xl:text-[6rem] 2xl:text-[7rem] 3xl:text-[7rem] font-bold leading-[1.1] tracking-tight max-w-4xl 2xl:max-w-6xl mb-8"
        >
        ...
        >
          <Link href="/site">
            ...
            >
              <span className="relative z-10">Ver Site Completo</span>
